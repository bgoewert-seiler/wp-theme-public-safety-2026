...
/**
 * Title: Testimonials
 * Slug: public-safety-2026/testimonials
 * Categories: public-safety-testimonials
...
<div class="wp-block-group alignfull testimonials-section has-white-background-color has-background" style="margin-top:0;margin-bottom:0;padding-top:var(--wp--preset--spacing--x-large);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--x-large);padding-left:var(--wp--preset--spacing--medium)">
	<!-- wp:heading {"textAlign":"center","style":{"spacing":{"margin":{"bottom":"var:preset|spacing|large"}},"typography":{"fontSize":"48px","fontWeight":"700"}}} -->
	<h2 class="wp-block-heading has-text-align-center" style="margin-bottom:var(--wp--preset--spacing--large);font-size:48px;font-weight:700">What Our Customers Say</h2>
	<!-- /wp:heading -->
	...
	<div class="wp-block-columns alignwide">
		...
		<div class="wp-block-column testimonial-card has-light-gray-background-color has-background has-border-color" style="border-color:var(--wp--preset--color--light-gray);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
			...
			<p style="font-size:18px;line-height:1.6">"The team provided exceptional support throughout our entire implementation. Their expertise in public safety solutions is unmatched."</p>
			<!-- /wp:paragraph -->
		...
		<div class="wp-block-column testimonial-card has-light-gray-background-color has-background has-border-color" style="border-color:var(--wp--preset--color--light-gray);border-width:1px;border-radius:8px;padding-top:var(--wp--preset--spacing--medium);padding-right:var(--wp--preset--spacing--medium);padding-bottom:var(--wp--preset--spacing--medium);padding-left:var(--wp--preset--spacing--medium)">
			<!-- wp:paragraph {"style":{"typography":{"fontSize":"18px","lineHeight":"1.6"}}} -->
			<p style="font-size:18px;line-height:1.6">"Outstanding training and customer service. They truly understand the unique challenges of public safety organizations."</p>
			<!-- /wp:paragraph -->
